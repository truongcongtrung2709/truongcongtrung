...
export default function HomeProjects({ projects }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        <Grid xs={6} md={2}>
          <SmallItem caseStudy={projects[0]} />
        </Grid>

        {!mdUp && (
          <Grid xs={6} md={2}>
            <SmallItem caseStudy={projects[5]} />
          </Grid>
        )}
        ...
        <Grid container xs={12} sm={12} md={8}>
          <Grid xs={6} md={9}>
            {mdUp ? (
              <LargeItem caseStudy={projects[1]} />
            ) : (
              <SmallItem caseStudy={projects[1]} square />
            )}
          </Grid>

          <Grid xs={6} md={3}>
            <Stack justifyContent={{ md: 'flex-end' }} sx={{ height: { md: 1 } }}>
              <SmallItem caseStudy={projects[2]} square />
            </Stack>
          </Grid>

          <Grid xs={6} md={3}>
            <SmallItem caseStudy={projects[3]} square />
          </Grid>

          <Grid xs={6} md={9}>
            {mdUp ? (
              <LargeItem caseStudy={projects[4]} />
            ) : (
              <SmallItem caseStudy={projects[4]} square />
            )}
          </Grid>
        </Grid>
