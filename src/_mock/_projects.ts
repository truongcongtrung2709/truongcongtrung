export const projects = [
  ...
  },
  {
    id: 'burgos',
    title: 'Burgos',
    linkDemo: 'https://burgos-nextjs.vercel.app',
    github: 'https://github.com/truongcongtrung2709/burgos-nextjs', // Replace with actual GitHub link
    coverUrl: 'assets/projects/burgos.jpg', // Replace with actual image path
    description: 'Created a website for selling burgers with a custom backend API using JSON-server, built with Next.js, TypeScript, and Tailwind CSS.'
  }
];